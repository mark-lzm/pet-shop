...
public class FosterDetailController {
     ...
     * 支付 or 领取
     */
    @RequestMapping("/updateFosterDetailBo")
    public R updateFosterDetailBo(@RequestBody FosterDetailBo bo) {
        Map<String, String> map = fosterDetailService.updateFosterDetailBo(bo);
